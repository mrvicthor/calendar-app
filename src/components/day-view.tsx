  ...
  return (
    <>
      ...
      <section className="flex flex-col divide-gray-100 divide-y-2 h-full">
        <div className="flex gap-2 items-center px-6 h-10">
        ...
        <ul className="flex-1 overflow-y-auto pl-12 relative">
          <div
            ...
            className="bg-red-400 absolute left-[4.98rem] w-full h-0.5 z-50"
          />
          {TIME_SLOTS.map((time, index) => (
            ...
            >
              ...
              <div className="min-h-full bg-[#E4E4E3] w-0.5 ml-8" />
            </li>
          ))}
        </ul>
      </section>
