...
const MonthView = () => {
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-7 grid-rows-[repeat(5,8rem)] max-h-[calc(100dvh-11.4rem)]">
        {calendarDays.map((dayInfo, index) => {
          ...
          return (
            <div
              ...
              className="border-r-[1px] flex flex-col gap-1 items-center border-b border-b-[#DDE3E9] border-r-[#DDE3E9] last:border-r-0 p-1 cursor-pointer hover:bg-gray-50"
            >
              <div
                onClick={(e) => {
                  e.stopPropagation();
